                            ...
                            <div className="space-y-8">
                                ...
                                <div className="p-6 bg-cream rounded-2xl border border-primary/5">
                                    <h3 className="font-black text-primary text-sm uppercase tracking-wider mb-2">
                                        {locale === 'ar' ? 'الوصف والتفاصيل' : 'Description & Details'}
                                    </h3>
                                ...
                                {item.estimatedCostMin && (
                                    <div className="p-6 bg-accent/5 rounded-2xl border border-accent/10">
                                        <h3 className="font-black text-accent-dark text-sm uppercase tracking-wider mb-2">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                {Array.isArray(item.media) && item.media.length > 0 && (
                                    <MaintenanceImageGallery
                                        locale={locale}
                                        images={item.media.map((m: any) => ({ id: m.id, url: m.url }))}
                                    />
                                )}
